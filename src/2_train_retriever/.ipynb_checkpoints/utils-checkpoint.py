...
class DATASTORE:
    def __init__(self, dataset, split):
        self.split_q_dir = os.path.join(data_paths.data_root, split, dataset + '_' + split + '_qlist.json')
        self.split_c_dir = os.path.join(data_paths.data_root, split, dataset + '_' + split + '_clist.json')
